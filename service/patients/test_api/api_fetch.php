...
foreach($result as $row)
{
	...
	$sub_array[] = '<button type="button" name="update" id="'.$row["hn_patient"].'" class="btn btn-warning btn-block update"><i class="fas fa-stethoscope"></i>แก้ไข</button>';
	$sub_array[] = '<button type="button" name="delete" id="'.$row["hn_patient"].'" class="btn btn-danger btn-block delete">
